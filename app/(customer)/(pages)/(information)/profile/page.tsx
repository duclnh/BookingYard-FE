...
export default function Profile() {
  ...
  const handlerSubmitUpdate = (data: FieldValues) => {
    ...
    <div className='col-span-3 rounded-2xl border'>
      ...
      <form method='POST' className='p-5' onSubmit={handleSubmit(handlerSubmitUpdate)}>
        ...
        <div className='mt-3 flex items-center justify-between w-56'>
          <Image height={70} width={70} className='rounded-[50%] border h-20 w-20' src={image || user?.imageUrl || '/assets/images/avatar-default.png'} alt="avatar" />
          ...
          <div className='sm:ml-5'>
            ...
            <div className='grid grid-cols-2 gap-2 lg:grid-cols-3 w-44 mt-3 lg:gap-5'>
              <div className="flex items-center gap-2">
                <Radio id="male" name="gender" value="male" defaultChecked={user?.gender == "Male" ? true : false} />
                <Label htmlFor="male">Nam</Label>
              </div>
              <div className="flex items-center gap-2">
                <Radio id="female" name="gender" value="female" defaultChecked={user?.gender == "Male" ? true : false} />
                <Label htmlFor="female">Nữ</Label>
              </div>
              <div className="flex items-center gap-2">
                <Radio id="other" name="gender" value="other" defaultChecked={user?.gender == "Other" ? true : false} />
